...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(template_name='log out.html'), name='user-logout'),
    path('addproduct/', general_views.addproduct, name='add-products'),
    ...
    path('update-product/<id>', general_views.updateproduct, name='update-product'),
